...
import { AlertCircle, ArrowRight, Building2, Mail } from "lucide-react";
      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardContent className="p-6">
            ...
            {unverifiedEmail && (
              <div className="mb-4 flex items-start gap-3 rounded-lg border border-amber-300 bg-amber-50 p-4 dark:border-amber-800 dark:bg-amber-950/30">
